...
function Footer() {
  return (
    <div className="bg-thrd h-28 flex flex-col md:flex-row items-center justify-between py-4 px-6 sm:px-5 md:px-[20px] sm:px-[20px] md:px-40 lg:px-50 xl:px-60 text-center md:text-left">
